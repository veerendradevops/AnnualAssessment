...
public class TrainingAndDevelopmentBean {
	...
	public String getFirstDateDue() {
		return firstDateDue;
	}

	public void setFirstDateDue(String firstDateDue) {
		this.firstDateDue = firstDateDue;
	}

	public String getSecondfDateDue() {
		return secondfDateDue;
	}

	public void setSecondfDateDue(String secondfDateDue) {
		this.secondfDateDue = secondfDateDue;
	}

	public String getThirdDateDue() {
		return thirdDateDue;
	}

	public void setThirdDateDue(String thirdDateDue) {
