...
public class ExemptSection2 implements Serializable {
	...
	public String toString() {
		return "ExemptSection2 [empClockNumber=" + empClockNumber + ", section2A1Objective=" + section2A1Objective
				+ ", section2A1Level=" + section2A1Level + ", section2A2Objective=" + section2A2Objective
				+ ", section2A2Level=" + section2A2Level + ", section2A3Objective=" + section2A3Objective
				+ ", section2A3Level=" + section2A3Level + ", section2A4Objective=" + section2A4Objective
				+ ", section2A4Level=" + section2A4Level + ", section2A5Objective=" + section2A5Objective
				+ ", section2A5Level=" + section2A5Level + ", section2AdditionalComments=" + section2AdditionalComments
				+ ", overallScore=" + overallScore + ", section2B1=" + section2B1 + ", section2B2=" + section2B2
				+ ", section2B3=" + section2B3 + ", section2CSummeryStrength=" + section2CSummeryStrength
				+ ", section2CSummeryImprovement=" + section2CSummeryImprovement
				+ ", section2DSummeryOfAccomplishmentAndAreasImprovement="
				+ section2DSummeryOfAccomplishmentAndAreasImprovement + ", section2EAssessmentSummary="
				+ section2EAssessmentSummary + ", section2EAssessmentcompared=" + section2EAssessmentcompared
				+ ", appraisalYear=" + appraisalYear + ", skills1=" + skills1 + ", skills2=" + skills2 + ", skills3="
				+ skills3 + ", skills4=" + skills4 + ", skills5=" + skills5 + ", skills6=" + skills6 + ", skills7="
				+ skills7 + ", skills8=" + skills8 + ", skills9=" + skills9 + ", skills10=" + skills10
				+ ", waysOfWorking1=" + waysOfWorking1 + ", waysOfWorking2=" + waysOfWorking2 + ", waysOfWorking3="
				+ waysOfWorking3 + ", waysOfWorking4=" + waysOfWorking4 + ", waysOfWorking5=" + waysOfWorking5
				+ ", waysOfWorking6=" + waysOfWorking6 + ", waysOfWorking7=" + waysOfWorking7
				+ ", selfManagementandLeadership1=" + selfManagementandLeadership1 + ", selfManagementandLeadership2="
				+ selfManagementandLeadership2 + ", selfManagementandLeadership3=" + selfManagementandLeadership3
				+ ", selfManagementandLeadership4=" + selfManagementandLeadership4 + ", selfManagementandLeadership5="
				+ selfManagementandLeadership5 + ", selfManagementandLeadership6=" + selfManagementandLeadership6
				+ ", selfManagementandLeadership7=" + selfManagementandLeadership7 + "]";
	}
