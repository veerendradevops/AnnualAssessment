				...
				<div class="col-md-12">
					...
					<div class="portlet light portlet-fit portlet-form bordered">
						...
						<div class="portlet-body">
							<!-- BEGIN FORM-->
							<form action="/AnnualAssessmenT/salaryreview.do"
...
<!-- 
	...
	<script type="text/javascript">
		function percent() {
			...
			hrlyfinal=hrlyfinal+parseFloat((percentage/100) * currenthourlyrate);
		
			var hrlyres = parseFloat(currenthourlyrate);
			
			var hrlfinalYears=(parseFloat(hrlyfinal)+parseFloat(hrlyres));
			
			var annualfinal=0.0;
			annualfinal = parseFloat((percentage/100) * currentannualrate);
            
			var annualres=parseFloat(currentannualrate);
