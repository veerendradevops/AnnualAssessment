...
public class ExemptTeamMemberPojoVariables {
	...
	private String countryFour;
	
	
	private String countryFive;
	
	private String countrySix;
	
	private String countrySeven;
	...
	/**
	 * @param countryOne the countryOne to set
	 */
	...
	/**
	 * @param countryTwo the countryTwo to set
	 */
	...
	/**
	 * @param countryThree the countryThree to set
	 */
	...
	/**
	 * @return the countryFour
	 */
	public String getCountryFour() {
		return countryFour;
	}

	/**
	 * @param countryFour the countryFour to set
	 */
	public void setCountryFour(String countryFour) {
		this.countryFour = countryFour;
	}

	/**
	 * @return the countryFive
	 */
	public String getCountryFive() {
		return countryFive;
	}

	/**
	 * @param countryFive the countryFive to set
	 */
	public void setCountryFive(String countryFive) {
		this.countryFive = countryFive;
	}

	/**
	 * @return the countrySix
	 */
	public String getCountrySix() {
		return countrySix;
	}

	/**
	 * @param countrySix the countrySix to set
	 */
	public void setCountrySix(String countrySix) {
		this.countrySix = countrySix;
	}

	/**
	 * @return the countrySeven
	 */
	public String getCountrySeven() {
		return countrySeven;
	}

	/**
	 * @param countrySeven the countrySeven to set
	 */
	public void setCountrySeven(String countrySeven) {
