...
public class JobKnowledgeAndSkillsBean {

	// all fields in JobKnowledgeAndSkillsBean
	...
	private String qualitySupervisiorsComments;
	...
	public String getQualitySupervisiorsComments() {
		return qualitySupervisiorsComments;
	}

	public void setQualitySupervisiorsComments(String qualitySupervisiorsComments) {
		this.qualitySupervisiorsComments = qualitySupervisiorsComments;
	}
	...
	public String getSupervisorsOveralComments() {
		return supervisorsOveralComments;
	}

	public void setSupervisorsOveralComments(String supervisorsOveralComments) {
		this.supervisorsOveralComments = supervisorsOveralComments;
	}
