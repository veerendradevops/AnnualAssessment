...
<html>
  ...
  <tr bgcolor="#F5F5F5">
   ...
   <!--  <th><a href="#">EmpPSID</a>
    ...
    <td><a href="/AnnaulAssessmenT/teamMemberPersonalInfo.do?clockNum=+${empDetail.empClockNumber}&year=${empDetail.annaulYear}"><c:out value="${empDetail.empClockNumber}"></c:out></a>  </td>
